...
class MLResearchSample(BaseModel):
    ...
    future_excess_return_1d: float | None = None
    future_excess_return_2d: float | None = None
    future_excess_return_3d: float | None = None
    future_excess_return_5d: float | None = None
    future_excess_return_10d: float | None = None
    future_excess_return_20d: float | None = None
    future_rank_pct_1d: float | None = None
    future_rank_pct_2d: float | None = None
    future_rank_pct_3d: float | None = None
    future_rank_pct_5d: float | None = None
    future_rank_pct_10d: float | None = None
    future_rank_pct_20d: float | None = None
    future_top30_1d: int | None = None
    future_top30_2d: int | None = None
    future_top30_3d: int | None = None
    future_top30_5d: int | None = None
    future_top30_10d: int | None = None
    future_top30_20d: int | None = None
    future_bottom30_1d: int | None = None
    future_bottom30_2d: int | None = None
    future_bottom30_3d: int | None = None
    future_bottom30_5d: int | None = None
    future_bottom30_10d: int | None = None
    future_bottom30_20d: int | None = None
